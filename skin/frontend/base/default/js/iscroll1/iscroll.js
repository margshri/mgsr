(function (b) {
    b.iscroll = function (d) {
        var m = b.extend({}, b.iscroll.defaults, d);
        var c = new b.iscroll.util();
        var j = new b.iscroll.paging();
        var h = (m.history ? new b.iscroll.history() : false);
        var f = this;
        r();
        ...
        function u() {
            loader = b(".iscroll_loader");
            if (loader.size() == 0) {
                loader = b("<div class='iscroll_loader'>" + m.loader + "</div>");
                loader.hide()
            }
            return loader
        }
    ...
    b.iscroll.history = function () {
        ...
        this.getState = function () {
            if (c) {
                ...
                if (stateObj && stateObj.iscroll) {
                    return stateObj.iscroll
                }
            } else {
