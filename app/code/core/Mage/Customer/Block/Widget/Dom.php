...
class Mage_Customer_Block_Widget_Dom extends Mage_Customer_Block_Widget_Abstract
{
    /**
     * Date inputs
     *
    ...
    public function _construct()
    {
        ...
        $this->setTemplate('customer/widget/dom.phtml');
    }

    public function isEnabled()
    {
        return (bool)$this->_getAttribute('dom')->getIsVisible();
    }

    public function isRequired()
    {
        return (bool)$this->_getAttribute('dom')->getIsRequired();
    }
