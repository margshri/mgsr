...
class Mage_Customer_Block_Address_Book extends Mage_Core_Block_Template
{
    ...
    {
    	return $this->getCustomer()->getPrimaryPermanentAddress();
    }
    
    public function getPrimaryResidenceAddress()
    {
    	return $this->getCustomer()->getPrimaryResidenceAddress();
    }
    ...
    {
        return $this->getPrimaryPermanentAddress() || $this->getPrimaryResidenceAddress() || $this->getPrimaryBillingAddress() || $this->getPrimaryShippingAddress();
    }
