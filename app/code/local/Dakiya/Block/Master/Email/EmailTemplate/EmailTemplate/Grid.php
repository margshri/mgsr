<?php
class Dakiya_Block_Master_Email_EmailTemplate_EmailTemplate_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	protected function _prepareCollection(){
		$collection =  Mage::getModel("dakiya/Master_Email_EmailTemplate")->getCollection();
	...
	protected function _prepareColumns(){
		...
		$this->addColumn('Edit', array(
				...
				'sortable'  => false,
				'filter'    => false,
				'renderer'  => 'dakiya/Master_Email_EmailTemplate_EmailTemplate_Renderer',
		));
