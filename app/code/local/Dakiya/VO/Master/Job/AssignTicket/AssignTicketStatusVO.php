<?php
class Dakiya_VO_Master_Job_AssignTicket_AssignTicketStatusVO extends Dakiya_VO_BaseVO{
	
	
	public static $OPEN = 1;
	public static $CLOSE = 2;
	public static $REOPEN = 3;
	...
	public function __construct(){
		$model = Mage::getModel("dakiya/Master_Job_AssignTicket_AssignTicketStatus");
