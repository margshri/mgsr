<?php
class Margshri_WebPortal_Block_Frontend_Footer_Advertisement extends Mage_Core_Block_Template{
    ...
    public function __construct()
    {
		...
		$collection->getSelect()->where('main_table.TypeID =?', Margshri_WebPortal_VO_FileUpload_ImageUpload_AdvertisementTypeVO::$FOOTER_BAR);
