<?php
class Margshri_WebPortal_Block_Frontend_Center_Content_Type7_Achivement_Achivement_Info extends Mage_Core_Block_Template{
	public function __construct(){
		parent::__construct();
		$this->setTemplate('webportal/center/content/type7/achivement/achivement/entropy.phtml');
		...
		$collection->getSelect()->Order('main_table.AchivementDate Asc');
