<?php
class Margshri_WebPortal_Block_Frontend_Center_Content_MiddleBar extends Mage_Core_Block_Template{
	
    public function __construct(){
    	
        parent::__construct();
        $this->setTemplate('webportal/center/content/middlebar.phtml');
