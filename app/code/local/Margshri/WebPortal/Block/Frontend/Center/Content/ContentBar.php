<?php
class Margshri_WebPortal_Block_Frontend_Center_Content_ContentBar extends Mage_Core_Block_Template{
	
    public function __construct(){
    	
        parent::__construct();
        $this->setTemplate('webportal/center/content/contentbar.phtml');
		...
		$collection->getSelect()->where('main_table.TypeID =?', Margshri_WebPortal_VO_FileUpload_ImageUpload_AdvertisementTypeVO::$CONTENT_BAR);
