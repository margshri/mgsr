<?php
class Margshri_WebPortal_Block_Frontend_Center_Content_Type7_News_News_Info extends Mage_Core_Block_Template{
	
	private $locationVO;
	
	public function __construct(){
		parent::__construct();
		$this->setTemplate('webportal/center/content/type7/news/news/entropy.phtml');
		...
		*/
		...
		// $collection->getSelect()->Order('main_table.NewsDate Asc');
