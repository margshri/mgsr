<?php
class Margshri_WebPortal_Block_Backend_Center_Content_Type10_Info extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface{
    ...
    public function getTypeOptions(){
    	$options = array();
    	$model = Mage::helper('webportal/Data')->getType10TypeModel($this->getTableCode());
    	$options = $model->getResource()->getOptions($this->getTableCode());
    	return $options;
    }
