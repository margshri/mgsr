<?php
class Margshri_WebPortal_Block_Backend_Center_Content_Type1_Bank_Branch_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	{
		try{
			$collection =  Mage::getModel("webportal/Center_Content_Type1_Bank_Branch")->getCollection();
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('Name', array(
				'header'    =>Mage::helper('adminhtml')->__('Branch Name'),
				'index'     =>'main_table.value',
		));
		
		$this->addColumn('Code', array(
				'header'    =>Mage::helper('adminhtml')->__('Branch Code'),
		...
		$this->addColumn('edit', array(
				...
				'sortable'  => false,
				'filter'    => false,
				'renderer'  => 'webportal/Backend_Center_Content_Type1_Bank_Branch_Renderer',
