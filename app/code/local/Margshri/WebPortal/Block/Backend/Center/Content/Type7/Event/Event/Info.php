<?php
class Margshri_WebPortal_Block_Backend_Center_Content_Type7_Event_Event_Info extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface{

	public function getTabLabel(){
        return Mage::helper('adminhtml')->__('Event Info');
    }
