<?php 
class Margshri_WebPortal_Block_Backend_Center_Content_Type7_News_News_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	{
		try{
			$collection =   Mage::getModel("webportal/Center_Content_Type7_News_News")->getCollection();
			$collection->getSelect()->reset()->from(array("main_table"=>$collection->getMainTable()), array("main_table.ID"=>"main_table.ID", "main_table.Value"=>"main_table.Value", "main_table.Code"=>"main_table.Code", "main_table.NewsDate"=>"main_table.NewsDate", "main_table.LaunchDate"=>"main_table.LaunchDate", "main_table.EndDate"=>"main_table.EndDate",  "main_table.DistrictID"=> "main_table.DistrictID", "main_table.edit"=> new Zend_Db_Expr("'Edit'") ));
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('NewsDate', array(
				'header'    =>Mage::helper('adminhtml')->__('News Date'),
				'index'     =>'main_table.NewsDate',
		));
		...
		$this->addColumn('Edit', array(
				...
				'sortable'  => false,
				'filter'    => false,
				'renderer'  => 'webportal/Backend_Center_Content_Type7_News_News_Renderer',
