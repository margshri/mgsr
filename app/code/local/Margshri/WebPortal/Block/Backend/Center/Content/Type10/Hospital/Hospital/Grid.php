<?php 
class Margshri_WebPortal_Block_Backend_Center_Content_Type10_Hospital_Hospital_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	{
		try{
			$collection =   Mage::getModel("webportal/Center_Content_Type10_Hospital_Hospital")->getCollection();
			...
			$collection->getSelect()->joinLeft(array("hospitaltype"=>$collection->getTable('webportal/apctwebhospitaltype')), 'main_table.HospitalTypeID = hospitaltype.ID', array("hospitaltype.ID"=>"hospitaltype.ID", "hospitaltype.Value"=>"hospitaltype.Value"));
	...
	protected function _prepareColumns()
	{
		...
		*/
		...
		$this->addColumn('HospitalTypeID', array(
				'header'    =>Mage::helper('adminhtml')->__('Hospital Type'),
				'type'  => 'options',
				'index' => 'hospitaltype.ID',
				'options' => Mage::getModel('webportal/Master_Center_Content_Type10_Hospital_HospitalType')->getResource()->getOptions()
		));
		...
		$this->addColumn('Edit', array(
				...
				'renderer'  => 'webportal/Backend_Center_Content_Type10_Hospital_Hospital_Renderer',
