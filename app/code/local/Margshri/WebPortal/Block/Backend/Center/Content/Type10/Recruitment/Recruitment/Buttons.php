<?php
class Margshri_WebPortal_Block_Backend_Center_Content_Type10_Recruitment_Recruitment_Buttons extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('entropy',
            $this->getLayout()->createBlock('webportal/Backend_Center_Content_Type10_Recruitment_Recruitment_Info') );
