<?php
class Margshri_WebPortal_Block_Backend_Center_Content_Type1_Bank_Branch_Info extends Mage_Adminhtml_Block_Widget_Form implements Mage_Adminhtml_Block_Widget_Tab_Interface{
    
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('webportal/center/content/type1/bank/branch/entropy.phtml');
    }

    public function getTabLabel()
    {
    	return Mage::helper('adminhtml')->__('Branch Info');
    }
