<?php
class Margshri_WebPortal_Block_Backend_Center_Content_Type8_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	{
		try{
			$collection =   Mage::helper('webportal/Data')->getType8Model($this->getTableCode())->getCollection();
	...
	protected function _prepareColumns()
	{
		...
		*/
		...
		$this->addColumn('Edit', array(
				...
				'renderer'  => 'webportal/Backend_Center_Content_Type8_Renderer',
