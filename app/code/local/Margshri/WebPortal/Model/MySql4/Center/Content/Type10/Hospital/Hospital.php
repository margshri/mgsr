<?php
class Margshri_WebPortal_Model_Mysql4_Center_Content_Type10_Hospital_Hospital extends Mage_Core_Model_Mysql4_Abstract{
	
	protected function _construct()
	{
		$this->_init('webportal/apctwebhospital', 'ID');
	}
