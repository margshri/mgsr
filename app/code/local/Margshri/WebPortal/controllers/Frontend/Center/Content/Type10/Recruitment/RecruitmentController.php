<?php 
class Margshri_WebPortal_Frontend_Center_Content_Type10_Recruitment_RecruitmentController extends Mage_Core_Controller_Front_Action {
	...
	public function indexAction(){
		...
		$this->loadLayout();
		$block = $this->getLayout()->createBlock('webportal/Frontend_Center_Content_Type10_Recruitment_Recruitment_Info');
		$block->setTemplate('webportal/center/content/type10/recruitment/recruitment/entropy.phtml');
	...
	public function detailAction(){
		...
		Mage::register("CurrentRecuitmentID", $this->entityID);
		Mage::register("CurrentTableCode", $this->tableCode);
		
		$this->loadLayout();
		// $block = $this->getLayout()->createBlock('webportal/Frontend_Center_Content_Type10_Recruitment_Recruitment_Detail');
		// $block->setTemplate('webportal/center/content/type10/recruitment/recruitment/detail.phtml');
		$block = $this->getLayout()->createBlock('webportal/Frontend_Center_Content_Type10_Recruitment_Recruitment_Info');
		$block->setTemplate('webportal/center/content/type10/recruitment/recruitment/entropy.phtml');
