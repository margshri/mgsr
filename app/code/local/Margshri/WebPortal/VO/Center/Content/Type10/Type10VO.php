<?php
class Margshri_WebPortal_VO_Center_Content_Type10_Type10VO extends Margshri_WebPortal_VO_BaseVO{
    ...
    public function __construct($tableCode){
    	$model = Mage::helper('webportal/Data')->getType10Model($tableCode);
