<?php
class Margshri_WebPortal_VO_Center_Content_Type7_News_NewsVO extends Margshri_WebPortal_VO_BaseVO{
    ...
    protected $_Image;
    protected $_PersonImage;
    protected $_Person2Image;
    protected $_NewsDate;
	...
	public function setPersonImage($value)
	{
		$this->_PersonImage = $value;
		$this->set('PersonImage' , $value);
	}
	
	
	public function getPerson2Image()
	{
		return $this->_Person2Image;
	}
	
	public function setPerson2Image($value)
	{
		$this->_Person2Image = $value;
		$this->set('Person2Image' , $value);
	}
	...
	public function setLaunchDate($value) 
	{
	  $this->_LaunchDate = $value;
	  $this->set('LaunchDate' , $value);
	}
	...
	public function getHospitalTypeID() 
	{
	  return $this->_HospitalTypeID;
	}
	
	public function setHospitalTypeID($value) 
	{
	  $this->_HospitalTypeID = $value;
	  $this->set('HospitalTypeID' , $value);
	}
