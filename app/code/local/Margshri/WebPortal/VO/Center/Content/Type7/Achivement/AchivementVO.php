<?php
class Margshri_WebPortal_VO_Center_Content_Type7_Achivement_AchivementVO extends Margshri_WebPortal_VO_BaseVO{
	...
	public function getAchivementDate() 
	{
	  return $this->_AchivementDate;
	}
	
	public function setAchivementDate($value) 
	{
	  $this->_AchivementDate = $value;
	  $this->set('AchivementDate' , $value);
	}
