<?php
class Margshri_WebPortal_VO_Master_Office_UserOfficeVO extends Margshri_WebPortal_VO_BaseVO{
	...
	public function setAdminUserID($value) 
	{
	  $this->_AdminUserID = $value;
	  $this->set('AdminUserID' , $value);
	}
