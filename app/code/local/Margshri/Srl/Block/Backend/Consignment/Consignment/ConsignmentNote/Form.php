<?php
class Margshri_Transport_Block_Backend_Consignment_Consignment_ConsignmentNote_Form extends Mage_Adminhtml_Block_Template{
	
    public $commonList = array(); 
    
    public function __construct(){
    	parent::__construct();
    	$this->setTemplate("transport/consignment/consignment/consignmentnote/form.phtml");
    }
    ...
    protected function _prepareLayout(){
        ...
        $this->setChild('printButton',
            ...
            ->setData(array(
                ...
                'onclick'   => 'window.location.href=\''.$this->getUrl('*/*/print').'\'',
            ))
        );
        ...
        $this->setChild('saveButton',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'onclick'   => 'consignmentNoteFormJS.submit(); ',
                    'class' => 'save'
                ))
        );
