<?php
class Margshri_Transport_Block_Backend_Master_Vahicale_Driver_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	protected function _prepareCollection(){
		...
		try{
			...
			$collection = Mage::getModel(Margshri_Transport_VO_Master_Vahicale_DriverVO::$modelName)->getCollection();
			$collection->getSelect()->reset()->from(array("main_table"=>$collection->getMainTable()), array("main_table.ID"=>"main_table.ID",
			    "main_table.Name"=>"main_table.Name", "main_table.MobileNo"=>"main_table.MobileNo",
			    "main_table.Address"=>"main_table.Address", "main_table.DLNo"=>"main_table.DLNo",
			    "main_table.AadharNo"=>"main_table.AadharNo", "main_table.StatusID"=>"main_table.StatusID",
	...
	protected function _prepareColumns(){
		...
		$this->addColumn('Name', array(
		    'header'    => Mage::helper('adminhtml')->__('Driver <br /> <br /> Name'),
		...
		$this->addColumn('MobileNo', array(
		    ...
		    'index'     => 'main_table.MobileNo',
		));
		
		$this->addColumn('DLNo', array(
		    'header'    => Mage::helper('adminhtml')->__('DL <br /> <br /> Number'),
		    'index'     => 'main_table.DLNo',
		));
		
		$this->addColumn('AadharNo', array(
		    'header'    => Mage::helper('adminhtml')->__('Aadhar <br /> <br /> Number'),
		    'index'     => 'main_table.AadharNo',
		));
		
		$this->addColumn('Address', array(
		    'header'    => Mage::helper('adminhtml')->__('Driver <br /> <br /> Address'),
		...
		$this->addColumn('Edit', array(
		    ...
		    'sortable'  => false,
		    'filter'    => false,
		    'renderer'  => 'transport/Backend_Master_Vahicale_Driver_Renderer',
