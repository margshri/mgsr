<?php
class Margshri_Transport_Block_Backend_Master_Vahicale_Owner_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	protected function _prepareCollection(){
		...
		try{
			...
			$collection = Mage::getModel(Margshri_Transport_VO_Master_Vahicale_OwnerVO::$modelName)->getCollection();
			$collection->getSelect()->reset()->from(array("main_table"=>$collection->getMainTable()), array("main_table.ID"=>"main_table.ID",
			    ...
			    "main_table.Address"=>"main_table.Address", "main_table.PANNo"=>"main_table.PANNo",
	...
	protected function _prepareColumns(){
		...
		$this->addColumn('Name', array(
		    'header'    => Mage::helper('adminhtml')->__('Owner <br /> <br /> Name'),
		...
		$this->addColumn('PANNo', array(
		    'header'    => Mage::helper('adminhtml')->__('PAN <br /> <br /> Number'),
		    'index'     => 'main_table.PANNo',
		));
		...
		$this->addColumn('Address', array(
		    'header'    => Mage::helper('adminhtml')->__('Owner <br /> <br /> Address'),
		...
		$this->addColumn('Edit', array(
		    ...
		    'sortable'  => false,
		    'filter'    => false,
		    'renderer'  => 'transport/Backend_Master_Vahicale_Owner_Renderer',
