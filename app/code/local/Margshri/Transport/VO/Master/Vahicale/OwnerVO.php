<?php
class Margshri_Transport_VO_Master_Vahicale_OwnerVO extends Margshri_Common_VO_ResponseVO{
	
    public static $modelName = "transport/Master_Vahicale_Owner";
    public static $tableAlias = "transport/mgsrvahicaleowner";
	...
	public function setPANNo($value){
	    $this->_PANNo = $value;
	    $this->set('PANNo' , $value);
	}
