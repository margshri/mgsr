<?php
class Margshri_Common_Block_Frontend_Donor_Donor_BuddhPurnimaDonorList extends Mage_Core_Block_Template{
    ...
    public function getDonationVOs(){
        ...
        $programmeID = 3; // pratibha samman samaroh 2018 
        ...
        foreach($donationDataObjs as $donationDataObj){
            ...
            $donationTypeIDs = array(1,2,13);
            if(in_array($donationVO->getDonationTypeID(), $donationTypeIDs) ){
                continue;
            }
            ...
            $donationVOs[$counter.$donationVO->getDonationTypeID()] = $donationVO;
            // $donationVOs[] = $donationVO;
        }
        // $newDonationVOs = ksort($donationVOs, 1);
        return $donationVOs;
    }
