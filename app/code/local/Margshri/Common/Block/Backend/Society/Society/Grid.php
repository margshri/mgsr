<?php
class Margshri_Common_Block_Backend_Society_Society_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	protected function _prepareCollection(){
		...
		try{
			...
			$collection = Mage::getModel(Margshri_Common_VO_Society_Society_SocietyVO::$modelName)->getCollection();
			$collection->getSelect()->reset()->from(array("main_table"=>$collection->getMainTable()), array("main_table.ID"=>"main_table.ID",
			    "main_table.Name"=>"main_table.Name", "main_table.Code"=>"main_table.Code",
			    "main_table.Address"=>"main_table.Address", "main_table.AreaID"=>"main_table.AreaID",
			    "main_table.RegistrationNo"=>"main_table.RegistrationNo", "main_table.StatusID"=>"main_table.StatusID",
	...
	protected function _prepareColumns(){
		...
		$this->addColumn('RegistrationNo', array(
				'header'    => Mage::helper('adminhtml')->__('RegistrationNo'),
				'index'     => 'main_table.RegistrationNo',
		));
		...
		$this->addColumn('Edit', array(
		    ...
		    'sortable'  => false,
		    'filter'    => false,
		    'renderer'  => 'common/Backend_Society_Society_Renderer',
