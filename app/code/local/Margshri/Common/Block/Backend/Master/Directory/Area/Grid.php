<?php
class Margshri_Common_Block_Backend_Master_Directory_Area_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	...
	protected function _prepareCollection(){
		...
		try{
			...
			$collection = Mage::getModel(Margshri_Common_VO_Directory_AreaList_AreaListVO::$modelName)->getCollection();
			$collection->getSelect()->reset()->from(array("main_table"=>$collection->getMainTable()), array("main_table.ID"=>"main_table.ID", 
			    ...
			    "main_table.CityID"=>"main_table.CityID", "main_table.StatusID"=>"main_table.StatusID",
	...
	protected function _prepareColumns(){
		...
		$this->addColumn('Edit', array(
		    ...
		    'sortable'  => false,
		    'filter'    => false,
		    'renderer'  => 'common/Backend_Master_Directory_Area_Renderer',
