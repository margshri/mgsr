<?php
class Margshri_Common_VO_Status_StatusVO extends Margshri_Common_VO_ResponseVO{
    
    public static $ACTIVE = 1;
    public static $INACTIVE = 2;
    
    public static $modelName = "common/Status_Status";
    public static $tableAlias = "common/mgsrstatus";
