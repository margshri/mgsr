<?php
class Margshri_Common_VO_User_User_UserVO extends Margshri_Common_VO_ResponseVO{
	
    public static $modelName = "common/User_User_User";
    public static $tableAlias = "common/mgsruser";
    ...
    protected $_ID;
    protected $_NamePrefixID;
    protected $_Name;
    protected $_ParentID;
    protected $_FatherName;
    protected $_UserImageURL;
    protected $_GenderID;
    protected $_BloodGroupID;
    protected $_IsStpEligible;
	...
	public function getNamePrefixID() {
	    return $this->_NamePrefixID;
	}
	public function setNamePrefixID($value){
	    $this->_NamePrefixID = $value;
	    $this->set('NamePrefixID' , $value);
	}
	...
	public function setUserImageURL($value){
	...
	public function setBloodGroupID($value){
	    $this->_BloodGroupID = $value;
	    $this->set('BloodGroupID' , $value);
	}
	
	public function getIsStpEligible() {
	    return $this->_IsStpEligible;
	}
	public function setIsStpEligible($value){
	    $this->_IsStpEligible = $value;
	    $this->set('IsStpEligible' , $value);
	}
