<?php 
class Margshri_Common_Backend_Book_ReceiptBookController extends Mage_Adminhtml_Controller_Action{
	
	private $gridBlock ='common/Backend_Book_ReceiptBook_Grid';
	private $formBlock ='common/Backend_Book_ReceiptBook_Form';
