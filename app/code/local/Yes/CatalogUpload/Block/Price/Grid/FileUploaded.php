...
class Yes_CatalogUpload_Block_Price_Grid_FileUploaded extends Mage_Adminhtml_Block_Widget_Grid //MageCoreInherit_Grid
{
   ...
   protected function _prepareCollection()
    {    
    	$collection =  Mage::getModel("yescatalogupload/fileUpload")->getCollection()
    			->addFieldToFilter('TemplateID',Yes_VO_Template_TemplateVO::$PRICE_UPLOAD_TEMPLATE_ID)
