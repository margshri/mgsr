...
class Yes_VO_Catalog_CatalogProductEntityTextVO extends Zend_Db_Table_Abstract
{
protected $_db;
	protected $_name;
	...
	public function __construct()
	{
		...
		$tableName = $model->getResource()->getTable('yescatalogupload/catalogproductentitytext');
