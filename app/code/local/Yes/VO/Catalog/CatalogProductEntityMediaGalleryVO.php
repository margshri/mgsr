...
class Yes_VO_Catalog_CatalogProductEntityMediaGalleryVO extends Zend_Db_Table_Abstract
{
	...
	public function __construct()
	{
		...
		$tableName = $model->getResource()->getTable('yescatalogupload/catalogproductentitymediagallery');
